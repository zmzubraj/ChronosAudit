...
def main() -> int:
    parser = argparse.ArgumentParser(description="Rebuild and verify a non-authorizing denominator expansion projection.")
    ...
    _write(args.output.expanduser().resolve(strict=False), verification)
