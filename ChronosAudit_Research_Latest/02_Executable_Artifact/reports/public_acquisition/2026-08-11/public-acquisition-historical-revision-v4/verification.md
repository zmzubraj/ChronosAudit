...
- Run ID: `public-acquisition-historical-revision-v4`
- Revision: `2026-08-11`
...
- `positive_review_packets`: PASS
  ...
  observed=417
- `human_adjudication_handoff`: PASS
...
- `ai_only_adjudication_track`: PASS
...
- AI-only internal progression gate is not passed: FAIL_RELIABILITY_THRESHOLD
