...
def _parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Build the exact non-authorizing no-replay trace retry subset.")
...
def main() -> int:
    ...
    payload = build_trace_retry_targets(
    ...
    print(json.dumps({
        "original_target_count": payload["original_target_count"],
        "source_complete_count": payload["source_complete_count"],
        "duplicate_agreement_count": payload["duplicate_agreement_count"],
        "unresolved_count": payload["unresolved_count"],
        "rpc_call_count": payload["rpc_call_count"],
        "rpc_authorized": False,
        "retry_targets_sha256": payload["retry_targets_sha256"],
